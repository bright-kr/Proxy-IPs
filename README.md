...
[![Promo](https://github.com/luminati-io/Rotating-Residential-Proxies/blob/main/50%25%20off%20promo.png)](https://brightdata.com/locations) 

## Overview
Experience seamless scraping with Bright Data's [Proxy IPs](https://brightdata.com/locations), designed to provide precise targeting, unmatched stability, and rapid response times. Start scraping websites from Australia and don't get blocked again.

- **Proxy IPs from 195 countries**
...
- [**US proxies**](https://brightdata.com/locations/united-states)
- [**China proxies**](https://brightdata.com/locations/cn)
- [**Germany proxies**](https://brightdata.com/locations/de)
- [**Brazil proxies**](https://brightdata.com/locations/br)
- [**Russia proxies**](https://brightdata.com/locations/ru)
- [**France proxies**](https://brightdata.com/locations/fr)
- [**South Korea proxies**](https://brightdata.com/locations/kr)
- [**Japan proxies**](https://brightdata.com/locations/united-states/jp)
...
- **700,000 static residential IPs**
...
## Integrations
Our Proxy IPs integrate with popular tools and frameworks, including:
...
## Popular Use Cases
Explore how businesses leverage Proxy IPs:
...
An Australia proxy server is a server that serves as an intermediary between your device and the internet. It provides anonymity, helps bypass restrictions and blocks, enables web content scraping, and enforces content filtering policies.

### Can I target ZIP codes?
Yes, you can choose IPs using zip code level targeting. Bright Data also offers city and state level US proxy targeting.
